  ...
  function renderCalendar() {
    ...
    const calendar = new Calendar(calendarEl, {
      ...
      events: getFilteredEvents().flatMap(e => {
        const baseEvent = {
          title: e.gcal_title ? "CFI Unavailable" : `${(e.tail_number && e.tail_number !== 'null') ? e.tail_number : (e.flight_type || 'G.L.')} → ${e.student_name}`,
          start: e.start,
          end: e.end,
      ...
      eventClick: function (info) {
        ...
        Swal.fire({
          ...
          html: `
            ...
            <b>🕵️‍♂️Student Identity: Removed to Protect the Innocent🦹‍♂️</b><br>
